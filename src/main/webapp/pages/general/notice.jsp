  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="main.jsp" style="height: 100%"><img src="../../images/HOMES.png" style="height: 100%" /></a>
        <a class="navbar-brand brand-logo" href="main.jsp"  style="color: rgba(0, 0, 0, 0.9)"><h1 id="logo">셜록HOMES</h1></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="estateList.jsp">
              <span class="menu-title">매물관리</span>
              <i class="mdi mdi-diamond menu-icon"></i>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="declaration.jsp">
