  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center"  >
        <a class="navbar-brand brand-logo" href="main.jsp" style="height: 100%"><img src="../../images/logo1.jpg" alt="logo"  style="height: 100%" /></a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="main.jsp">일반사용자</a></li>
                <li class="nav-item"> <a class="nav-link" href="main.jsp">공인중개사</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
